...
checkbox.addEventListener("change", function () { return __awaiter(_this, void 0, void 0, function () {
    var response, data, link, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, fetch("https://jackbear-lotoapi.r954jc.easypanel.host/versions/latest")];
            case 2:
                response = _a.sent();
            ...
            case 4:
                error_1 = _a.sent();
                console.error("Erro ao buscar versão:", error_1);
